...
export function ResumeForm() {
  const [skills, setSkills] = useState(["Figma", "React", "User Research", "Prototyping"])
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <Input placeholder="Senior UX Designer" defaultValue="Senior UX Designer" className="bg-white" />
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <Input type="number" placeholder="5" defaultValue="5" className="bg-white" />
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-2">Press Enter to add a skill.</p>
        </div>

        {/* Writing Tone */}
        <div>
          <label className="block text-sm font-medium mb-3">Writing Tone</label>
          <ToggleGroup value={tone} onValueChange={setTone} type="single">
            <ToggleGroupItem
              value="professional"
